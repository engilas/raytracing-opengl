...
{
	spheres.push_back(create_spheres({ 2,0,4 }, { 0,1,0 }, 1, 10, 0.0f, 0, 0.7));
	...
	spheres.push_back(create_spheres({ 0,0.8,1 }, { 0,0,0 }, 0.5, 500, 0.4f, 1.125, 0.7));

	//lights.push_back(create_light(ambient, 0.2f, { 1,1,1 }, { 0 }, { 0 }));
	lights.push_back(create_light(point, 2.6f, {1,1,1}, { 2, 1, 0 }, { 0 }));
	lights.push_back(create_light(direct, 1.2f, { 1,1,1 }, { 0 }, { 1,4,4 }));
