...
rt_sphere SceneManager::create_spheres(vec3 center, vec3 color, float radius, int specular, float reflect, float refract, float diffuse)
{
	rt_sphere sphere = {};
    ...
    sphere.material.kd = 0.8;
    sphere.material.ks = 0.2;
...
{
	spheres.push_back(create_spheres({ 2,0,4 }, { 0,1,0 }, 1, 30, 0.0f, 0, 0.7));
	...
	spheres.push_back(create_spheres({ 0,-1001,3 }, { 1,1,1 }, 1000, 50, 0.0f, 0, 0.18));
	...
	lights.push_back(create_light(point, 55.0f, {0.4,0.9,0.7}, { 2, 5, 0 }, { 0 }));
